		...
		public function shortcode($atts = null, $content = null) {
			...
			*/
			...
			$shortcode_ops = array(
				...
				'markup' => array(
					'custom_html' => true,
					'wpp-start' => empty($wpp_start) ? '<ol class="wpp-list">' : $wpp_start,
					'wpp-end' => empty($wpp_end) ? '</ol>' : $wpp_end,
